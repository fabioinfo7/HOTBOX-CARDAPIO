        ...
        <div className="bio-shell">
          ...
          <section className="order-section" aria-label="Canais para fazer seu pedido">
            ...
            <div className="order-grid">
              <a
                href={WHATSAPP_URL}
                onClick={() => trackAnalytics("bio_channel_click", { category: "conversion", label: "WhatsApp", metadata: { surface: "bio", channel: "whatsapp" } })}
                target="_blank"
              ...
              <a
                href={IFOOD_URL}
                onClick={() => trackAnalytics("bio_channel_click", { category: "conversion", label: "iFood", metadata: { surface: "bio", channel: "ifood" } })}
                target="_blank"
                rel="noopener noreferrer"
              ...
              <a
                href={NFOOD_URL}
                onClick={() => trackAnalytics("bio_channel_click", { category: "conversion", label: "99Food", metadata: { surface: "bio", channel: "99food" } })}
                target="_blank"
                rel="noopener noreferrer"
