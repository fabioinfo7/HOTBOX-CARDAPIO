...
import { Route as ApiPublicReengagementProcessRouteImport } from './routes/api/public/reengagement.process'
import { Route as ApiPublicWebhooksAppmaxRouteImport } from './routes/api/public/webhooks.appmax'
import { Route as ApiPublicWebhooksEfiRouteImport } from './routes/api/public/webhooks.efi'
...
const AuthenticatedLojaAnalyticsRoute = AuthenticatedLojaAnalyticsRouteImport.update({
  id: '/analytics',
  path: '/analytics',
...
const ApiPublicAnaliseCollectRoute = ApiPublicAnaliseCollectRouteImport.update({
...
const ApiPublicAppmaxValidationRoute = ApiPublicAppmaxValidationRouteImport.update({
  id: '/api/public/appmax/validation',
  path: '/api/public/appmax/validation',
  getParentRoute: () => rootRouteImport,
} as any)
const ApiPublicReengagementProcessRoute = ApiPublicReengagementProcessRouteImport.update({
  id: '/api/public/reengagement/process',
  path: '/api/public/reengagement/process',
  getParentRoute: () => rootRouteImport,
} as any)
const ApiPublicWebhooksAppmaxRoute = ApiPublicWebhooksAppmaxRouteImport.update({
  id: '/api/public/webhooks/appmax',
  path: '/api/public/webhooks/appmax',
  getParentRoute: () => rootRouteImport,
} as any)
const ApiPublicWebhooksEfiRoute = ApiPublicWebhooksEfiRouteImport.update({
  id: '/api/public/webhooks/efi',
  path: '/api/public/webhooks/efi',
  getParentRoute: () => rootRouteImport,
} as any)
...
const ApiPublicWebhooksPagarmeRoute = ApiPublicWebhooksPagarmeRouteImport.update({
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/_authenticated/loja/analytics': {
      id: '/_authenticated/loja/analytics'
      path: '/analytics'
      fullPath: '/loja/analytics'
      preLoaderRoute: typeof AuthenticatedLojaAnalyticsRouteImport
    ...
    '/api/public/appmax/validation': {
      id: '/api/public/appmax/validation'
      path: '/api/public/appmax/validation'
      fullPath: '/api/public/appmax/validation'
      preLoaderRoute: typeof ApiPublicAppmaxValidationRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/public/reengagement/process': {
      id: '/api/public/reengagement/process'
      path: '/api/public/reengagement/process'
      fullPath: '/api/public/reengagement/process'
      preLoaderRoute: typeof ApiPublicReengagementProcessRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/public/webhooks/appmax': {
      id: '/api/public/webhooks/appmax'
      path: '/api/public/webhooks/appmax'
      fullPath: '/api/public/webhooks/appmax'
      preLoaderRoute: typeof ApiPublicWebhooksAppmaxRouteImport
      parentRoute: typeof rootRouteImport
    }
    '/api/public/webhooks/efi': {
      id: '/api/public/webhooks/efi'
      path: '/api/public/webhooks/efi'
      fullPath: '/api/public/webhooks/efi'
      preLoaderRoute: typeof ApiPublicWebhooksEfiRouteImport
      parentRoute: typeof rootRouteImport
    }
...
const AuthenticatedLojaRouteChildren = {
  AuthenticatedLojaAnalyticsRoute: AuthenticatedLojaAnalyticsRoute,
...
const rootRouteChildren = {
  ...
  ApiPublicAppmaxValidationRoute: ApiPublicAppmaxValidationRoute,
  ApiPublicReengagementProcessRoute: ApiPublicReengagementProcessRoute,
  ApiPublicWebhooksAppmaxRoute: ApiPublicWebhooksAppmaxRoute,
  ApiPublicWebhooksEfiRoute: ApiPublicWebhooksEfiRoute,
