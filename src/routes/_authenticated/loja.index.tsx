          ...
          {activeList.map((o) => {
            ...
            return (
              ...
              >
                ...
                {o.payment_timing === "delivery" && o.payment_status !== "paid" && (
                  <div className="mx-4 mb-2 rounded-xl border-2 border-amber-500 bg-amber-50 px-3 py-2 shadow-sm">
                    <div className="flex items-center gap-2">
                      <Wallet className="size-4 shrink-0 text-amber-700" />
                      <p className="text-xs font-black uppercase tracking-wide text-amber-950">Pagamento na entrega</p>
                    </div>
                    <p className="mt-1 text-xs font-bold text-amber-800">
                      Receber {o.payment_method === "pix" ? "por Pix" : "no cartão"} • {brl(o.total)}
                    </p>
                  </div>
                )}
