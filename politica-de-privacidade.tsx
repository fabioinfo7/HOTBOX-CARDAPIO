      ...
      <div className="space-y-6">
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li><strong>Histórico de conversa:</strong> mensagens trocadas com nosso atendimento (automático ou humano) pelo WhatsApp, para dar continuidade ao seu pedido e melhorar o atendimento.</li>
            <li><strong>Dados de navegação e comportamento:</strong> páginas visitadas, cliques, etapas do funil, profundidade de rolagem, tempo aproximado de engajamento, origem/referrer, parâmetros UTM e informações técnicas do dispositivo/navegador. Esses registros usam identificadores técnicos de visitante e sessão e não gravam senha, dados de cartão, CVV nem o conteúdo digitado nos campos do checkout.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <ul className="list-disc space-y-1 pl-5">
            ...
            <li>Analisar a jornada no site para identificar gargalos, abandono, desempenho de campanhas e oportunidades de melhorar a experiência e a conversão.</li>
