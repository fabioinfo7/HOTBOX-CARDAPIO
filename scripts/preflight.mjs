...
const checks = [
  ...
  ['src/routes/_authenticated/loja.config.tsx', 'appmax_merchant_client_id'],
  ['src/routes/_authenticated/loja.config.tsx', 'appmax_merchant_client_secret'],
  ...
  ['src/routes/_authenticated/loja.financeiro-cardapio.tsx', 'Appmax'],
  ['src/routes/index.tsx', 'MercadoPagoPayment'],
  ['src/routes/index.tsx', 'AppmaxPayment'],
